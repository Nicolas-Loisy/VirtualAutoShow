...
class VueMenu{
    ...
    public function __construct (){
        $this->contenu = "<a href=index.php><h1>TP3</h1></a> <a href=index.php?module=Voiture&action=bienvenue>Voiture</a> <a href=index.php?module=listeVoiture&action=liste>Liste Voiture</a> ";
